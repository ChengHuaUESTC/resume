...
\textit{}\ 后台开发工程师/分布式存储开发工程师

\section{\faUsers\  项目经历}
\datedsubsection{\textbf{美团}  北京}{2015年9月 -- 至今}
\role{美团云图片处理系统}{}
美团云图片处理系统是构建于美团云对象存储的图片处理系统。支持缩放、裁剪、旋转、图文水印、格式转换、拼图、样式管理等功能；功能全面，使用方便，已被公司业务广泛使用。整个项目采用Go语言+ImageMagick库开发完成。API地址：https://www.mtyun.com/doc/api/mss/mss/tu-pian-chu-li-fu-wu-api
\begin{itemize}
  \item 独立负责整个系统的设计、开发和维护。
...
\datedsubsection{\textbf{美团}  北京}{2017年5月 -- 2017年6月}
\role{美团云自研CDN：日志系统}{}
