...
\datedsubsection{\textbf{美团}  北京}{2015年9月 -- 2018年10月}
\role{美团图片服务}{}
美团图片服务是构建于美团对象存储上的图片处理系统。支持缩放、裁剪、旋转、图文水印、格式转换、拼图和样式管理，功能全面，使用方便，已被公司内外业务广泛使用。整个项目采用Go语言+ImageMagick库开发。
\begin{itemize}
  ...
  \item 集群为双机房部署，每个机房为独立缓存系统，提升系统的可用性
  \item API地址：https://www.mtyun.com/doc/api/mss/mss/tu-pian-chu-li-fu-wu-api
\end{itemize}

\datedsubsection{\textbf{美团}  北京}{2015年12月 -- 至今}
\role{美团新一代对象存储系统}{}
